...
from .config_schema_track_info import config_schema_track_info_op
# from .duplicates_table import create_duplicates_table_op
from google.cloud import bigquery

def load_new_track_info_op(clean_new_tracks):
    schema, job_config = config_schema_track_info_op()
    client = connect_to_bigquery_op()
    table_id = "snappy-boulder-378707.NewReleases.NewTracks"
    table_id_dup = "snappy-boulder-378707.NewReleases.NewTracksDuplicates"
    
    # create_duplicates_table_op(config_schema_track_info_op, table_id_dup)
    ...
    #     INSERT INTO snappy-boulder-378707.NewReleases.NewTracksDuplicates
    #     WITH first_row AS (
    ...
    #     )
    #     SELECT id, name, explicit, available_markets, popularity, album_id, artist_id, extract_date
    #     FROM first_row
    #     WHERE row_number = 1
    # """)
    ...
    #     DELETE FROM snappy-boulder-378707.NewReleases.NewTracks
    #     WHERE id
    #     IN (SELECT DISTINCT id FROM snappy-boulder-378707.NewReleases.NewTracksDuplicates)
    # """)
    ...
    #     INSERT INTO snappy-boulder-378707.NewReleases.NewTracks
    #     SELECT * FROM snappy-boulder-378707.NewReleases.NewTracksDuplicates
    # """)
    # insert_back.result()
    # table = client.get_table(table_id)
    ...
    #     TRUNCATE TABLE snappy-boulder-378707.NewReleases.NewTracksDuplicates
    # """)
